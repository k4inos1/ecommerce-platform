      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto mb-10 leading-relaxed">
            Los mejores productos tech con envío express, garantía extendida y pagos seguros con Stripe.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/products?category=Laptops" className="btn-ghost text-base px-8 py-4">
              Ver Laptops
            </Link>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              { icon: <ShieldCheck className="w-5 h-5" />, title: 'Stripe SSL', desc: 'Pagos 100% seguros' },
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <Link
              ...
              className={`group relative flex flex-col items-center gap-3 p-5 rounded-2xl border bg-gradient-to-b ${cat.color} transition-all duration-200 hover:-translate-y-0.5`}
            >
      ...
      <section className="max-w-6xl mx-auto px-4 pb-24">
        <div className="card p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative grid md:grid-cols-3 gap-8">
            {[
              { icon: <Zap className="w-6 h-6" />, title: 'Stock real', desc: 'Inventario actualizado en tiempo real desde el panel de administración.' },
              { icon: <Star className="w-6 h-6" />, title: 'Reseñas verificadas', desc: 'Solo clientes reales pueden dejar reseñas. Sin falsas valoraciones.' },
              { icon: <Package className="w-6 h-6" />, title: 'Tracking completo', desc: 'Seguimiento de tu orden desde el pago hasta la entrega en tu puerta.' },
            ].map(f => (
